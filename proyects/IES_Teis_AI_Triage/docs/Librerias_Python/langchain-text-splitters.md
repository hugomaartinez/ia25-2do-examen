...
2.  **`CaracterTextSplitter`**: Una versión más simple que divide bajodosis en un carácter específico definido por el usuario.
...
> **Repositorio en GitHub:** [langchain-text-splitters](https://github.com/langchain-ai/langchain/tree/master/libs/text-splitters_)