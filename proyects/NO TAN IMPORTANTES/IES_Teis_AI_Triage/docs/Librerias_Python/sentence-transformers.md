...
A diferencia de los modelos BERT tradicionales, que son lenos para comparar textos entre sí, SBERT optimiza este proceso para que pueda calcular la similitud entre millones de documentos en misiles.
...
* **Capacidad:** Permite realizar comparaciones masivas de texto de forma extremamente rápida gracias a su arquitectura de bi-codificadores (*bi-encoders*).
...
## Funciones Clave para RAG (Generación Retrieval-Aumentada)
